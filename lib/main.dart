...
class ChessApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final leftPanelWidth = screenWidth * 0.2; // Left panel is 20% of window width
            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Column(
                    children: context.watch<GameService>().visualMoveHistory.map((move) {
                      return ListTile(
                        title: Text(move),
                      );
                    }).toList(),
  ...
  child: Center(
    child: Column(
      ...
      children: [
        SizedBox(
  height: labelWidth, // Label height is the same as board cell height
  width: chessboardSize,
  child: Row(
    mainAxisAlignment: MainAxisAlignment.center,
    children: List.generate(8, (index) {
      return SizedBox(
        width: chessboardSize / 8, // Each label cell has the same width as the board cells
        child: Center(
          child: Text(
        ...
        Expanded(
          child: Row(
            ...
            children: [
              // Column labels
              SizedBox(
                width: labelWidth, // Label width is the same as board cell width
